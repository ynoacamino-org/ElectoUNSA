  ...
  if (!data) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <Link to="/listas" className="text-blue-600 hover:underline mt-4">Volver a las listas</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white py-10 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-unsa-granate mb-2">
            {data.nombre}
          </h1>
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-col gap-4">
            {data.documentos.map((doc, index) => (
              <div 
                key={index} 
                className="flex items-center gap-4 p-4 border border-gray-300 rounded-lg shadow-sm bg-white hover:shadow-md transition-shadow cursor-pointer"
              >
                <div className="p-2">
            ...
            {data.integrantes.map((member, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow bg-white">
                  <h4 className="text-lg font-bold text-unsa-granate mb-2 leading-tight">
                    {member.nombre}
                  </h4>
