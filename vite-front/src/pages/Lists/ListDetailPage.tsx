              ...
              return (
                <div key={index} className="flex flex-col border-2 border-unsa-granate/20 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
                  ...
                  <div className="p-6 flex flex-col flex-grow bg-white">
                    ...
                    <button
                      onClick={() => generateCVPDF(member)}
                      className="mt-auto w-full bg-unsa-granate text-white font-bold py-2.5 rounded-lg hover:bg-unsa-granate/90 transition-colors text-sm cursor-pointer"
                    >
